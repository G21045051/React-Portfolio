    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          Feel free to reach out to discuss your project needs and explore how we can collaborate to create something exceptional. I look forward to bringing your vision to life!
          </p>
        ...
        <form 
          action="https://getform.io/f/ayvpzlzb"
          method="POST"
